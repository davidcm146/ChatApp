...
const Message = ({fromCurrentUser, seen, senderImage, senderName, lastByUser, content, createdAt, type}: Props) => {
    const formatTime = (timestamp : number) => {
        return format(timestamp, "HH:mm");
    };
  return (
    <div className={cn("flex items-end py-1", {
        ...
        <Avatar className={cn("relative w-8 h-8", {
            ...
            "bottom-7" : !lastByUser && fromCurrentUser
