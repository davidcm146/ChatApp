...
const CreateGroupDialog = () => {
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="block bg-white text-black">
                <DialogHeader>
                    <DialogTitle>
                        Create Group
                    </DialogTitle>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8">
                        ...
                        {
                            members && members.length ? <Card className="flex items-center gap-4 overflow-x-auto w-full h-24 p-2 no-scrollbar">
                                    ...
                                    return (
                                        <div key={friend._id} className="flex flex-col items-center gap-1">
                                            <div className="relative">
                                                ...
                                                <X className="text-muted-foreground w-4 h-4 shadow-md absolute bottom-8 left-7 bg-muted rounded-full cursor-pointer" onClick={() => form.setValue("members", members.filter((id)=> id !== friend._id))}/>
                                            </div>
